...
<template>
  <div class="home-hero">
    <div class="hero-content">
      <h1 class="title">
        <span class="gradient">Grain</span>
      </h1>
      <p class="subtitle">Universal interaction layer for AI interfaces</p>
...
.home-hero {
  ...
  background: radial-gradient(circle at 50% 10%, rgba(255, 255, 255, 0.03) 0%, transparent 50%);
}
